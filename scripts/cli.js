...
const contractABI = require("../artifacts/contracts/Pancakeswap.sol/Pancakeswap.json").abi;

program
    .name("pancakeswap-cli")
    .description("CLI tool for Pancakeswap smart contract")
    .version("1.0.0");
